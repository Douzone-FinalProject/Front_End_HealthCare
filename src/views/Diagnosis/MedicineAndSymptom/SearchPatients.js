...
function SearchPatients(props) {
    return(
        <>
        <div className="mt-4">
            <h4 className={cx("diagnosis-opinionAndSearch-title","mb-2")}>환자 검색</h4>
            <input className={cx("diagnosis-searchPatients-input")} type="text" placeholder="차트번호"/>
            <input type="date"/>
            ...
            <div className={cx("mt-3")}>
                <Button className={cx("diagnosis-button","diagnosis-opinionAndSearch-button")}>검색</Button>
