        ...
        <table className={cx("result-toptable", "table table-borderless mt-4")}>
            <tbody>
                <tr>
                    ...
                    <td width='150' style={{backgroundColor: '#f8f9fa'}}>{props.patientData.patient_name}</td>
                    <td className={cx("result-toptablecol")} width='100'>진단명</td>
                    <td width='170' style={{backgroundColor: '#f8f9fa'}}>{props.patientData.symptom_name}</td>
                ...
                <tr>
                    ...
                    <td style={{backgroundColor: '#f8f9fa'}}>{props.specimenData.diagnostic_list_barcode}</td>
